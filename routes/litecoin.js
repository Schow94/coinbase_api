...
//   try {
//     //Make API call here
//     const products = await publicClient.getProductHistoricRates('LTC-USD', {
//       granularity: 86400,
//     });
...
//         'INSERT INTO LTC_historic_rates (time, low, high, open, close, volume) VALUES ($1, $2, $3, $4, $5, $6)',
...
router.get('/sortByTimeDesc', async (req, res, next) => {
  try {
    const result = await db.query(
      'SELECT * FROM LTC_historic_rates ORDER BY time DESC'
    );
...
router.get('/sortByTimeAsc', async (req, res, next) => {
  try {
    const result = await db.query(
      'SELECT * FROM LTC_historic_rates ORDER BY time ASC'
    );
...
router.get('/sortByHighDesc', async (req, res, next) => {
  try {
    const result = await db.query(
      'SELECT * FROM LTC_historic_rates ORDER BY high DESC'
    );
...
router.get('/sortByHighAsc', async (req, res, next) => {
  try {
    const result = await db.query(
      'SELECT * FROM LTC_historic_rates ORDER BY high ASC'
    );
...
router.get('/sortByLowDesc', async (req, res, next) => {
  try {
    const result = await db.query(
      'SELECT * FROM LTC_historic_rates ORDER BY low DESC'
    );
...
router.get('/sortByLowAsc', async (req, res, next) => {
  try {
    const result = await db.query(
      'SELECT * FROM LTC_historic_rates ORDER BY low ASC'
    );
...
router.get('/sortByOpenDesc', async (req, res, next) => {
  try {
    const result = await db.query(
      'SELECT * FROM LTC_historic_rates ORDER BY open DESC'
    );
...
router.get('/sortByOpenAsc', async (req, res, next) => {
  try {
    const result = await db.query(
      'SELECT * FROM LTC_historic_rates ORDER BY open ASC'
    );
...
router.get('/sortByCloseDesc', async (req, res, next) => {
  try {
    const result = await db.query(
      'SELECT * FROM LTC_historic_rates ORDER BY close DESC'
    );
...
router.get('/sortByCloseAsc', async (req, res, next) => {
  try {
    const result = await db.query(
      'SELECT * FROM LTC_historic_rates ORDER BY close ASC'
    );
...
router.get('/sortByVolumeDesc', async (req, res, next) => {
  try {
    const result = await db.query(
      'SELECT * FROM LTC_historic_rates ORDER BY volume DESC'
    );
...
router.get('/sortByVolumeAsc', async (req, res, next) => {
  try {
    const result = await db.query(
      'SELECT * FROM LTC_historic_rates ORDER BY volume ASC'
    );
